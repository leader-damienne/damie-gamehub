...
export const GAMES: GameDef[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Ramassez les pièces d’or.",
      "Une voiture en face = game over.",
    ],
    perks: ["Course arcade, réflexes purs.", "Les voies rapides boostent score et microns."],
  },
  {
    id: "wheelie-gold",
    title: "Wheelie Gold",
    ...
    rules: [
      ...
      "Passez les trous en wheelie, puis relâchez.",
      "Trop cabré ou un trou à plat : partie terminée.",
    ],
    perks: ["Timing de moto, parties tendues.", "Les pièces en l’air rapportent plus."],
  },
  {
    id: "gold-rally",
    title: "Gold Rally",
    ...
    rules: [
      ...
      "Évitez les voitures noires.",
      "Les pièces d’or et les dépassements marquent.",
    ],
    perks: ["Pilotage libre, pas seulement 3 voies.", "Le trafic accélère avec le score."],
  },
  {
    id: "nitro-crown",
    title: "Nitro Crown",
    ...
    rules: [
      ...
      "Passez au-dessus des fosses.",
      "Un atterrissage dans le trou termine la partie.",
    ],
    perks: ["Sauts courts, rythme de rallye.", "Chaque fosse franchie rapporte gros."],
  },
  {
    id: "ring-fighter",
    title: "Ring Fighter",
    ...
    rules: [
      ...
      "Touchez la gauche pour bloquer, la droite pour frapper.",
      "Trois coups encaissés terminent le combat.",
    ],
    perks: ["Duel 1 contre 1.", "Enchaînez les K.O. pour un gros score."],
  },
  {
    id: "turret-siege",
    title: "Turret Siege",
    ...
    rules: [
      ...
      "Détruisez les bombes avant le bas de l’écran.",
      "Une bombe au sol = défaite.",
    ],
    perks: ["Défense de vague.", "Cadence et visée font monter les couronnes."],
  },
  {
    id: "tank-push",
    title: "Tank Push",
    ...
    rules: [
      ...
      "Maintenez pour enchaîner les tirs.",
      "Un rocher sur le tank termine la partie.",
    ],
    perks: ["Blindé, parties plus longues.", "Bon pour viser 600 pts en mise."],
  },
  {
    id: "sky-ace",
    title: "Sky Ace",
    ...
    rules: [
      ...
      "Évitez les cercles de flak.",
      "Collectez l’or en vol.",
    ],
    perks: ["Vol libre, pas un simple tap.", "Les rafales s’élargissent : anticipez."],
  },
  {
    id: "jet-strike",
    title: "Jet Strike",
    ...
    rules: [
      ...
      "Maintenez pour tirer.",
      "Un choc ou un jet qui passe = fin.",
    ],
    perks: ["Shoot ’em up or.", "Les vagues s’accélèrent."],
  },
  {
    id: "hover-dash",
    title: "Hover Dash",
    ...
    rules: [
      ...
      "Ramassez l’or en vol.",
      "Une bombe sur votre rail termine la course.",
    ],
